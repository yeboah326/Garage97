    ...
    <Router>
      <Switch>
        <div className="container splashcontainer">
          ...
          <PrivateRoute
            exact
            path="/business/sales/addsales"
            component={AddSales}
          />
          <PrivateRoute
            exact
            path="/business/stocks/addstocks"
            component={AddStocks}
          />
          <PrivateRoute
            exact
            path="/business/stocks/stocklist"
            component={StockListPage}
          />
          <PrivateRoute
            exact
            path="/business/sales/salelist"
            component={SalesListPage}
          />
          <PrivateRoute
            exact
            path="/business/stocks/editstocklist"
            component={EditStockList}
          />
          <PrivateRoute
            exact
            path="/business/sales/editsalelist"
          ...
          <PrivateRoute
            exact
            path="/business/businessreport"
            component={BusinessReport}
          />
          <PrivateRoute
            exact
            path="/business/product/productreport"
