    ...
    >
      ...
      <div className="option main">
        <NavLink
          ...
          activeClassName="active"
        >
          <SvgBriefcase fill="#c0c0c0" />
          <Options optionName="Businesses" />
        </NavLink>
      </div>
      <div className="option main">
        <NavLink
          ...
          activeClassName="active"
        >
          <SvgBoxThin fill="#c0c0c0" />
          <Options optionName="Products" />
        </NavLink>
      </div>
      <div className="option main">
        <NavLink
          ...
          activeClassName="active"
        >
          <SvgDelivery fill="#c0c0c0" />
          <Options optionName="Stock" />
        </NavLink>
      </div>
      <div className="option main">
        <NavLink
      ...
      <div className="option main">
        <NavLink
          ...
          activeClassName="active"
        >
          <SvgReport fill="#c0c0c0" />
          <Options optionName="Report" />
        </NavLink>
      </div>
      <div
        className="logout"
      ...
      >
        <NavLink to="" className="logout-link options-link-1">
