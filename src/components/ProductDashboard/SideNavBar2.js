...
const SideNavBar2 = ({onHover,navwidth}) => {
    return (
        <div className="side-nav-bar2" onMouseOver={onHover} style={{width:navwidth}}>
            ...
            <div className='option main'><NavLink to='/products' className='options-link-1' activeClassName='active'><SvgBoxThin fill='#c0c0c0'/></NavLink></div>
            <div className='option main'><NavLink to='/stocks1' className='options-link-1' activeClassName='active'><SvgDelivery fill='#c0c0c0'/></NavLink></div>
            <div className='option main'><NavLink to='/Sales' className='options-link-1' activeClassName='active'><SvgTag fill='#c0c0c0'/></NavLink></div>
